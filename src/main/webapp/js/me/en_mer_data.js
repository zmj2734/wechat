...
$(function() {
    ...
    mui.app_request('POST', {
        ...
        if(data.RESULTCODE == '0') {
            ...
            if(info.state == -1) {
                ...
                document.getElementById("shop_type").innerHTML = data.RESULTLIST.shop_category_id_name;
                ...
                $("#errorValue").html(data.RESULTLIST.refuse);
                $("#errorReport").show();
                var html = '';
    ...
    document.getElementById('requerd').addEventListener('tap', function() {
        ...
        var params = {
            ...
            "SHOP_LOGO_URL": urls,
            "BRIEF_INTRODUTION":content_shop , //商家简介
        }
